...
## [0.0.7](https://github.com/RSS1102/farm/compare/farmfe_plugin_runtime-v0.0.6...farmfe_plugin_runtime-v0.0.7) - 2024-05-24

### Added
- support exclude/include option for html ([#1319](https://github.com/RSS1102/farm/pull/1319))
- support obj external & dts support resolvedPaths ([#1282](https://github.com/RSS1102/farm/pull/1282))

### Fixed
- minify not work ([#1317](https://github.com/RSS1102/farm/pull/1317))
- external inject logic ([#1313](https://github.com/RSS1102/farm/pull/1313))
- cache issues ([#1301](https://github.com/RSS1102/farm/pull/1301))
